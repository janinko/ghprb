...
* Under Branches to build:
  * If you **just** want to build PRs, set ``Branch Specifier`` to ``${sha1}`` instead of the default ``*/master``.
  * If you want to build PRs **and** branches, click ``Add Branch`` and enter ``${sha1}``.
